...
class RealTimeTwistPlotterNode(Node):
    def __init__(self):
        super().__init__('realtime_twist_plotter_node')
        
        # --- Parameters ---
        self.declare_parameter('topic_name', '/cmd_vel_smoothed')
